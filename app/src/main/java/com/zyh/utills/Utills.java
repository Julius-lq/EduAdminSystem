...
public class Utills {
    ...
    private static final Stack<Thread> threadStack = new Stack();
    static Map<String, Integer> map = new HashMap();
    static List<Integer> list = new ArrayList<>();
    static List<Integer> full = new ArrayList<>();
    private static final int[] colors = {0xFFFF2E63, 0xFF66BFBF, 0xFFFF9999, 0XFFE889E5, 0xFF4791B1, 0xFF00BBF0
    ...
    public static TimetableFragment getTimetableFragmeent(Fragment fragment) {
        ...
        List<Fragment> list = fragment.requireActivity().getSupportFragmentManager().getFragments();
    ...
    public static void showTimetable(final Fragment timetableFragment, final Activity activity, final List<List<CourseBean.Course>> courseList,
            ...
            public void run() {
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //显示备注
                        Utills.showNote(activity, notes, noteNames, index + "", TimetableFragment.semester, courseList);
                        //添加备注
        ...
        if (TimetableFragment.isThisSemester && TimetableFragment.thisWeek == index) {
            ...
            @SuppressLint("SimpleDateFormat") SimpleDateFormat dateFm = new SimpleDateFormat("EEEE");
            ...
            for (int j = 0; j < 7; j++) { //星期几
                ...
                showAddNote.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (timetableFragmentItem.nowAddNote != null)
                            timetableFragmentItem.nowAddNote.setVisibility(View.INVISIBLE);
                        if (timetableFragmentItem.nowShowAddNote != null)
                            timetableFragmentItem.nowShowAddNote.setVisibility(View.VISIBLE);
                        showAddNote.setVisibility(View.INVISIBLE);
...
//        }
    ...
    public static void showIsNowWeek(String selectSemester, String originalSemester, TextView isNowWeek,
        ...
        TimetableFragment.isThisSemester = selectSemester.equals(originalSemester);
    ...
    public static void initCourseView(View view, TextView[] weekDate, CardView[][] courseItems,
        ...
        /*weekDate*/
        weekDate[0] = view.findViewById(R.id.table_Sundaydate);
        weekDate[1] = view.findViewById(R.id.table_Mondaydate);
        weekDate[2] = view.findViewById(R.id.table_Tuesdaydate);
        weekDate[3] = view.findViewById(R.id.table_Wednesdaydate);
        weekDate[4] = view.findViewById(R.id.table_Thursdaydate);
        weekDate[5] = view.findViewById(R.id.table_Fridaydate);
        weekDate[6] = view.findViewById(R.id.table_Saturdaydate);

        /*courseItems*/

        courseItems[0][0] = view.findViewById(R.id.course_1_1);
        courseItems[0][1] = view.findViewById(R.id.course_2_1);
        courseItems[0][2] = view.findViewById(R.id.course_3_1);
        courseItems[0][3] = view.findViewById(R.id.course_4_1);
        courseItems[0][4] = view.findViewById(R.id.course_5_1);
        courseItems[0][5] = view.findViewById(R.id.course_6_1);
        courseItems[0][6] = view.findViewById(R.id.course_7_1);

        courseItems[1][0] = view.findViewById(R.id.course_1_2);
        courseItems[1][1] = view.findViewById(R.id.course_2_2);
        courseItems[1][2] = view.findViewById(R.id.course_3_2);
        courseItems[1][3] = view.findViewById(R.id.course_4_2);
        courseItems[1][4] = view.findViewById(R.id.course_5_2);
        courseItems[1][5] = view.findViewById(R.id.course_6_2);
        courseItems[1][6] = view.findViewById(R.id.course_7_2);

        courseItems[2][0] = view.findViewById(R.id.course_1_3);
        courseItems[2][1] = view.findViewById(R.id.course_2_3);
        courseItems[2][2] = view.findViewById(R.id.course_3_3);
        courseItems[2][3] = view.findViewById(R.id.course_4_3);
        courseItems[2][4] = view.findViewById(R.id.course_5_3);
        courseItems[2][5] = view.findViewById(R.id.course_6_3);
        courseItems[2][6] = view.findViewById(R.id.course_7_3);

        courseItems[3][0] = view.findViewById(R.id.course_1_4);
        courseItems[3][1] = view.findViewById(R.id.course_2_4);
        courseItems[3][2] = view.findViewById(R.id.course_3_4);
        courseItems[3][3] = view.findViewById(R.id.course_4_4);
        courseItems[3][4] = view.findViewById(R.id.course_5_4);
        courseItems[3][5] = view.findViewById(R.id.course_6_4);
        courseItems[3][6] = view.findViewById(R.id.course_7_4);

        courseItems[4][0] = view.findViewById(R.id.course_1_5);
        courseItems[4][1] = view.findViewById(R.id.course_2_5);
        courseItems[4][2] = view.findViewById(R.id.course_3_5);
        courseItems[4][3] = view.findViewById(R.id.course_4_5);
        courseItems[4][4] = view.findViewById(R.id.course_5_5);
        courseItems[4][5] = view.findViewById(R.id.course_6_5);
        courseItems[4][6] = view.findViewById(R.id.course_7_5);
        ...
        courseMsgs[0][0] = new Course(view.findViewById(R.id.course_1_1_name),
                view.findViewById(R.id.course_1_1_place), view.findViewById(R.id.course_1_1_property));
        courseMsgs[0][1] = new Course(view.findViewById(R.id.course_2_1_name),
                view.findViewById(R.id.course_2_1_place), view.findViewById(R.id.course_2_1_property));
        courseMsgs[0][2] = new Course(view.findViewById(R.id.course_3_1_name),
                view.findViewById(R.id.course_3_1_place), view.findViewById(R.id.course_3_1_property));
        courseMsgs[0][3] = new Course(view.findViewById(R.id.course_4_1_name),
                view.findViewById(R.id.course_4_1_place), view.findViewById(R.id.course_4_1_property));
        courseMsgs[0][4] = new Course(view.findViewById(R.id.course_5_1_name),
                view.findViewById(R.id.course_5_1_place), view.findViewById(R.id.course_5_1_property));
        courseMsgs[0][5] = new Course(view.findViewById(R.id.course_6_1_name),
                view.findViewById(R.id.course_6_1_place), view.findViewById(R.id.course_6_1_property));
        courseMsgs[0][6] = new Course(view.findViewById(R.id.course_7_1_name),
                view.findViewById(R.id.course_7_1_place), view.findViewById(R.id.course_7_1_property));

        courseMsgs[1][0] = new Course(view.findViewById(R.id.course_1_2_name),
                view.findViewById(R.id.course_1_2_place), view.findViewById(R.id.course_1_2_property));
        courseMsgs[1][1] = new Course(view.findViewById(R.id.course_2_2_name),
                view.findViewById(R.id.course_2_2_place), view.findViewById(R.id.course_2_2_property));
        courseMsgs[1][2] = new Course(view.findViewById(R.id.course_3_2_name),
                view.findViewById(R.id.course_3_2_place), view.findViewById(R.id.course_3_2_property));
        courseMsgs[1][3] = new Course(view.findViewById(R.id.course_4_2_name),
                view.findViewById(R.id.course_4_2_place), view.findViewById(R.id.course_4_2_property));
        courseMsgs[1][4] = new Course(view.findViewById(R.id.course_5_2_name),
                view.findViewById(R.id.course_5_2_place), view.findViewById(R.id.course_5_2_property));
        courseMsgs[1][5] = new Course(view.findViewById(R.id.course_6_2_name),
                view.findViewById(R.id.course_6_2_place), view.findViewById(R.id.course_6_2_property));
        courseMsgs[1][6] = new Course(view.findViewById(R.id.course_7_2_name),
                view.findViewById(R.id.course_7_2_place), view.findViewById(R.id.course_7_2_property));

        courseMsgs[2][0] = new Course(view.findViewById(R.id.course_1_3_name),
                view.findViewById(R.id.course_1_3_place), view.findViewById(R.id.course_1_3_property));
        courseMsgs[2][1] = new Course(view.findViewById(R.id.course_2_3_name),
                view.findViewById(R.id.course_2_3_place), view.findViewById(R.id.course_2_3_property));
        courseMsgs[2][2] = new Course(view.findViewById(R.id.course_3_3_name),
                view.findViewById(R.id.course_3_3_place), view.findViewById(R.id.course_3_3_property));
        courseMsgs[2][3] = new Course(view.findViewById(R.id.course_4_3_name),
                view.findViewById(R.id.course_4_3_place), view.findViewById(R.id.course_4_3_property));
        courseMsgs[2][4] = new Course(view.findViewById(R.id.course_5_3_name),
                view.findViewById(R.id.course_5_3_place), view.findViewById(R.id.course_5_3_property));
        courseMsgs[2][5] = new Course(view.findViewById(R.id.course_6_3_name),
                view.findViewById(R.id.course_6_3_place), view.findViewById(R.id.course_6_3_property));
        courseMsgs[2][6] = new Course(view.findViewById(R.id.course_7_3_name),
                view.findViewById(R.id.course_7_3_place), view.findViewById(R.id.course_7_3_property));

        courseMsgs[3][0] = new Course(view.findViewById(R.id.course_1_4_name),
                view.findViewById(R.id.course_1_4_place), view.findViewById(R.id.course_1_4_property));
        courseMsgs[3][1] = new Course(view.findViewById(R.id.course_2_4_name),
                view.findViewById(R.id.course_2_4_place), view.findViewById(R.id.course_2_4_property));
        courseMsgs[3][2] = new Course(view.findViewById(R.id.course_3_4_name),
                view.findViewById(R.id.course_3_4_place), view.findViewById(R.id.course_3_4_property));
        courseMsgs[3][3] = new Course(view.findViewById(R.id.course_4_4_name),
                view.findViewById(R.id.course_4_4_place), view.findViewById(R.id.course_4_4_property));
        courseMsgs[3][4] = new Course(view.findViewById(R.id.course_5_4_name),
                view.findViewById(R.id.course_5_4_place), view.findViewById(R.id.course_5_4_property));
        courseMsgs[3][5] = new Course(view.findViewById(R.id.course_6_4_name),
                view.findViewById(R.id.course_6_4_place), view.findViewById(R.id.course_6_4_property));
        courseMsgs[3][6] = new Course(view.findViewById(R.id.course_7_4_name),
                view.findViewById(R.id.course_7_4_place), view.findViewById(R.id.course_7_4_property));

        courseMsgs[4][0] = new Course(view.findViewById(R.id.course_1_5_name),
                view.findViewById(R.id.course_1_5_place), view.findViewById(R.id.course_1_5_property));
        courseMsgs[4][1] = new Course(view.findViewById(R.id.course_2_5_name),
                view.findViewById(R.id.course_2_5_place), view.findViewById(R.id.course_2_5_property));
        courseMsgs[4][2] = new Course(view.findViewById(R.id.course_3_5_name),
                view.findViewById(R.id.course_3_5_place), view.findViewById(R.id.course_3_5_property));
        courseMsgs[4][3] = new Course(view.findViewById(R.id.course_4_5_name),
                view.findViewById(R.id.course_4_5_place), view.findViewById(R.id.course_4_5_property));
        courseMsgs[4][4] = new Course(view.findViewById(R.id.course_5_5_name),
                view.findViewById(R.id.course_5_5_place), view.findViewById(R.id.course_5_5_property));
        courseMsgs[4][5] = new Course(view.findViewById(R.id.course_6_5_name),
                view.findViewById(R.id.course_6_5_place), view.findViewById(R.id.course_6_5_property));
        courseMsgs[4][6] = new Course(view.findViewById(R.id.course_7_5_name),
                view.findViewById(R.id.course_7_5_place), view.findViewById(R.id.course_7_5_property));

        /*course2Items*/


        @SuppressLint("CutPasteId") RelativeLayout relativeLayout = view.findViewById(R.id.course1);
        course2Items[0][0] = view.findViewById(R.id.top1);
        course2Items[0][1] = (CardView) relativeLayout.getChildAt(0);
        course2Items[0][2] = view.findViewById(R.id.top3);
        course2Items[0][3] = view.findViewById(R.id.top4);
        course2Items[0][4] = view.findViewById(R.id.top5);
        course2Items[0][5] = view.findViewById(R.id.top6);
        course2Items[0][6] = view.findViewById(R.id.top7);

        course2Items[1][0] = view.findViewById(R.id.course_1_34);
        course2Items[1][1] = view.findViewById(R.id.course_2_34);
        course2Items[1][2] = view.findViewById(R.id.course_3_34);
        course2Items[1][3] = view.findViewById(R.id.course_4_34);
        course2Items[1][4] = view.findViewById(R.id.course_5_34);
        course2Items[1][5] = view.findViewById(R.id.course_6_34);
        course2Items[1][6] = view.findViewById(R.id.course_7_34);


        course2Msgs[0][0] = new Course(view.findViewById(R.id.course_1_12_name),
                view.findViewById(R.id.course_1_12_place), view.findViewById(R.id.course_1_12_property));
        course2Msgs[0][1] = new Course(view.findViewById(R.id.course_2_12_name),
                view.findViewById(R.id.course_2_12_place), view.findViewById(R.id.course_2_12_property));
        course2Msgs[0][2] = new Course(view.findViewById(R.id.course_3_12_name),
                view.findViewById(R.id.course_3_12_place), view.findViewById(R.id.course_3_12_property));
        course2Msgs[0][3] = new Course(view.findViewById(R.id.course_4_12_name),
                view.findViewById(R.id.course_4_12_place), view.findViewById(R.id.course_4_12_property));
        course2Msgs[0][4] = new Course(view.findViewById(R.id.course_5_12_name),
                view.findViewById(R.id.course_5_12_place), view.findViewById(R.id.course_5_12_property));
        course2Msgs[0][5] = new Course(view.findViewById(R.id.course_6_12_name),
                view.findViewById(R.id.course_6_12_place), view.findViewById(R.id.course_6_12_property));
        course2Msgs[0][6] = new Course(view.findViewById(R.id.course_7_12_name),
                view.findViewById(R.id.course_7_12_place), view.findViewById(R.id.course_7_12_property));

        course2Msgs[1][0] = new Course(view.findViewById(R.id.course_1_34_name),
                view.findViewById(R.id.course_1_34_place), view.findViewById(R.id.course_1_34_property));
        course2Msgs[1][1] = new Course(view.findViewById(R.id.course_2_34_name),
                view.findViewById(R.id.course_2_34_place), view.findViewById(R.id.course_2_34_property));
        course2Msgs[1][2] = new Course(view.findViewById(R.id.course_3_34_name),
                view.findViewById(R.id.course_3_34_place), view.findViewById(R.id.course_3_34_property));
        course2Msgs[1][3] = new Course(view.findViewById(R.id.course_4_34_name),
                view.findViewById(R.id.course_4_34_place), view.findViewById(R.id.course_4_34_property));
        course2Msgs[1][4] = new Course(view.findViewById(R.id.course_5_34_name),
                view.findViewById(R.id.course_5_34_place), view.findViewById(R.id.course_5_34_property));
        course2Msgs[1][5] = new Course(view.findViewById(R.id.course_6_34_name),
                view.findViewById(R.id.course_6_34_place), view.findViewById(R.id.course_6_34_property));
        course2Msgs[1][6] = new Course(view.findViewById(R.id.course_7_34_name),
                view.findViewById(R.id.course_7_34_place), view.findViewById(R.id.course_7_34_property));
    }
    ...
    public static void postAllTimetable(final LoginBean loginBean, final Fragment timetableFragment, final String semester, final int nowWeek) {
        ...
        if (couList != null) {
            ...
            for (int i = 1; i <= 20; i++) {
                ...
                if (courseBean == null)
                    Log.i(TAG, "courseBean is null, couList[i]: " + couList.getCourseResponseDatas().get(i));
                if (courseBean.getMsg().equals("教务系统暂无该课表")) {
                    couList.delete();
                    flag = false;
                    break;
                }
                if (TimetableFragment.semester.equals(semester)) {
            ...
            public void run() {
                ...
                for (int week = nowWeek; ; week = (week + 1) % 21) {
                    ...
                    if (flag && week == nowWeek) {
                        ...
                        for (int i = 1; i <= 20; i++) {
                            if (cList.getCourseResponseDatas().get(i) == null)
                                Log.i(TAG, "this cList " + i + " is null!!!");
                            else
                                Log.i(TAG, "this cList " + i + " is " + cList.getCourseResponseDatas().get(i));
                        }
                        //      Log.d("test", cList.isSaved()+"");
                        cList.save();
                        //     Log.d("test", cList.isSaved()+"");
                        CourseList cList1 = LitePal.where("semester = ?", semester).findFirst(CourseList.class);
                        Log.i(TAG, "save success " + semester);
                        for (int i = 1; i <= 20; i++) {
                            if (cList1.getCourseResponseDatas().get(i) == null)
                                Log.i(TAG, "this cList " + i + " is null!!!");
                            else
                                Log.i(TAG, "this cList " + i + " is " + cList1.getCourseResponseDatas().get(i));
                        }
                        break;
                    }
                    ...
                    try {
                        ...
                        Request request = new Request.Builder()
                                .url("http://finalab.cn:8989/getCourse")
                                .post(requestBody)
